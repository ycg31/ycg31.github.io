...
(function ($, CONFIG) {
    ...
    function searchResultToDOM (searchResult) {
        ...
        if($("div.ins-section-container:has(section)").length == 0 ) {
           $container.append('<li class="tips" style="list-style-type:none;"><i class="fa fa-coffee fa-3x"></i><p>Results not found!</p></li>');
        }
    ...
    $(document).on('click focus', '.aa-input', function () {
        $main.addClass('show');
